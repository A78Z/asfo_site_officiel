...
import { ChevronRight, Calendar, MapPin, Users, Activity, Stethoscope, Baby, Heart, TrendingUp, Sparkles } from 'lucide-react';
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-start group">
                ...
                <span className="text-lg text-gray-700 font-medium leading-relaxed">
                  Oréfondé - Ndiafane - Diorbiwol - Agnam - Asndéballa - Doumga Ouro Alpha
                </span>
              </div>
              
              <div className="flex items-start group">
                <div className="w-10 h-10 bg-purple-100 rounded-xl flex items-center justify-center mr-3 mt-0.5 group-hover:bg-purple-200 transition-colors duration-300">
                  <Users size={18} className="text-purple-600" />
                </div>
                <span className="text-lg text-gray-700 font-medium leading-relaxed">
                  105 professionnels, 9083 patients consultés, 419 enfants circoncis, <br/>5 accouchements réalisés
                </span>
              </div>
            </div>
