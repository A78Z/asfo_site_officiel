      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="relative inline-block">
            ...
            <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl border border-teal-100">
              ...
              <div className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-teal-600 to-blue-600 bg-clip-text text-transparent mb-4">
                <StatCounter value={20000} />
              </div>
              
              <p className="text-xl md:text-2xl text-gray-700 font-medium">
                bénéficiaires de nos actions depuis 2000
              </p>
