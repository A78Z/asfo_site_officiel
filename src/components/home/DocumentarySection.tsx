      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
            ...
            <div className="relative bg-white rounded-2xl p-4 shadow-xl border border-gray-100 overflow-hidden">
              <div className="relative aspect-video rounded-xl overflow-hidden">
                <iframe 
                  ...
                  src="https://www.youtube.com/embed/QtCIyH1yuOQ?rel=0" 
              ...
              <div className="mt-4 p-4 bg-gradient-to-r from-teal-50 to-blue-50 rounded-xl">
                <p className="text-gray-700 text-center">
                  <span className="font-medium">Documentaire ASFO</span> - Suivez notre équipe médicale lors de nos missions humanitaires au Sénégal
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 text-center">
            <a 
              href="https://www.youtube.com/watch?v=QtCIyH1yuOQ" 
              target="_blank" 
              rel="noopener noreferrer"
              className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-red-500 to-red-600 text-white font-medium rounded-xl hover:from-red-600 hover:to-red-700 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 shadow-lg hover:shadow-xl"
            >
              <Play size={20} className="mr-3 transition-transform duration-300 group-hover:scale-110" />
