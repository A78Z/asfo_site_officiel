        ...
        <div className="relative mt-16 pt-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <Link to="/privacy" className="text-gray-400 text-sm lg:text-base hover:text-white transition-all duration-300 hover:translate-x-1 relative group">
              ...
              <Link to="/terms" className="text-gray-400 text-sm lg:text-base hover:text-white transition-all duration-300 hover:translate-x-1 relative group">
